...
int main(int argc, char **argv)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, fdWidth, fdHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, NULL);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, fdWidth, fdHeight); // use a single renderbuffer object for both a depth AND stencil buffer.
